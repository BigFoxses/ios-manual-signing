...
def parse_args():
    parser = argparse.ArgumentParser(
        description="Display APK SIGNING CERTFIFICATE Fingeprint from IPA"
    )
...
def apksignercert_run_command(cmd, _stdin=None, _stdout=None, _stderr=None):
    ...
    Args:
        ...
        _stdin ([type], optional): [description]. Defaults to None.
        _stdout ([type], optional): [description]. Defaults to None.
        _stderr ([type], optional): [description]. Defaults to None.
